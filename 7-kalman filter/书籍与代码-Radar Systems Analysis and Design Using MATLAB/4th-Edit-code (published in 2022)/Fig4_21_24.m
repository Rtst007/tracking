...
ylabel('\bfpropagation factor in dB')
axis tight
axis([2 45 -60 20])
figure(2)
plot(Rd./1000, F_dbr,'b',Rd./1000, F_free,'k-.','linewidth',1)
grid
xlabel('\bfslant range in Km')
ylabel('\bfPropagation factor in dB')
axis tight
axis([2 45 -40 80])
legend('\bfwith multipath','\bffree space')
title('frequency = 10GHz; ht = 120 m; hr = 60 m')
