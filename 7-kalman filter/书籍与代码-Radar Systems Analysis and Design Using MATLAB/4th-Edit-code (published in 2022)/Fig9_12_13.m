...
for j = 0:40
    ...
    plot(Rtgt/1000,10*log10(SNR),'b','linewidth',1.5);
    ylabel('\bfSNR in dB'); grid on
    subplot(4,1,2), hold on
    plot(Rtgt/1000,10*log10(CNR),'b','linewidth',1.5);
    ylabel('\bfCNR in dB');grid on
    subplot(4,1,3), hold on
    plot(Rtgt/1000,10*log10(SCR),'b','linewidth',1.5);
    ylabel('\bfSCR in dB') ;grid on
    subplot(4,1,4), hold on
    plot(Rtgt/1000,10*log10(SIR),'b','linewidth',1.5);
