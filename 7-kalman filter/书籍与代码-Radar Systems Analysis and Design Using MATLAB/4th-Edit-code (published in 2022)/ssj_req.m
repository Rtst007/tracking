...
BR_range = sqrt((pt * (10^(g/10)) * sigma * bj * (10^(lossj/10))) / (4.0 * pi * pj * (10^(gj/10)) * br * (10^(loss/10)))) / 1000.0 
BR_range = sqrt((pt * (10^(g/10)) * sigma * bj * (10^(lossj/10))) / (4.0 * pi * pj * (10^(gj/10)) * br * (10^(loss/10))))   
...
figure(1)
semilogx (ranvar,s,'b',ranvar,ssj,'r','linewidth',1.5);

xlabel ('Range - km');
legend('Target echo','ESJ or SCJ')
