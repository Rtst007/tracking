% This program produces Figs 3.12 and 3.13 of text
clc;
clear all
...
tau=50e-6;
b =667e3;    % radar operating bandwidth in Hz
loss = .1000;     % radar losses in dB
rangej = 45.0; % range to jammer in Km
...
figure (2)
subplot (2,1,1)
semilogx (BR_pj,'b','linewidth',1.5)
xlabel ('Jammer peak power - Watts');
ylabel ('Cross-over range - Km')
grid
subplot (2,1,2)
semilogx (BR_pt,'b','linewidth',1.5)
