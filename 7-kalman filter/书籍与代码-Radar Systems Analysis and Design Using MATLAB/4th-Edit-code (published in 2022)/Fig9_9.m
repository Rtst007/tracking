% Use this code to generate Fig. 9.9 of text
clc
clear all
close all
...
[sigmmaC] = clutter_rcs(sigmma0, theta_EL, theta_AZ, SL, range, hr, ht, B,1);
...
figure(2)
subplot(3,1,1)  
plot(range,10*log10(SNR),'b','linewidth',1.5);
ylabel('\bfSNR in dB'); grid on;axis tight
subplot(3,1,2) 
plot(range,10*log10(CNR),'b','linewidth',1.5);
ylabel('\bfCNR in dB');grid on;axis tight
subplot(3,1,3)
plot(range,10*log10(SCR),'b','linewidth',1.5);
